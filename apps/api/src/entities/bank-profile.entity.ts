...
export class BankProfileEntity {
  ...
  /**
   * Business portal search ID (MID / listing code), entered by admins for operator copy UX.
  ...
  /**
   * Thin bot file for run_bot.py — e.g. tp_127_executabes/TP_PAYTM_TXN_MID.py
   */
