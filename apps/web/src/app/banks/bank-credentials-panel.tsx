...
function isWalletAppProfile(profileKey: string): boolean {
  const u = profileKey.toUpperCase();
...
export function BankCredentialsPanel({ detail }: { detail: BankDetailPlain }) {
  const walletApp = isWalletAppProfile(detail.profileKey);
